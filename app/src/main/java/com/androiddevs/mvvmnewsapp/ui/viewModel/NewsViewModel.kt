...
class NewsViewModel(app: Application, val newsRepository: NewsRepository) : AndroidViewModel(
    app
    ...
    private suspend fun safeSearchNewsCall(searchQuery: String) {
        ...
        try {
            ...
            when (t) {
                ...
                // conversion from json to javaObject failed from retrofit
            }
        }
    }
